    ...
    return (
        <View style={styles.container__tarjetaConsejos}>
            ...
            <FontAwesome name="calendar-check-o" size={24} color="hsl(199, 76%, 28%)" />  
                    ...
                    {idiomaActual === "paisesBajos" && <Text style={{color:"white", letterSpacing:1, fontSize:RFValue(13),fontFamily: 'NunitoSans_400Regular',}}>Trainiere 10–30 Minuten pro Tag, um die besten Ergebnisse zu erzielen. Beständigkeit ist entscheidend</Text>}
            ...
            <AntDesign name="clockcircleo" size={24} color="hsl(199, 76%, 28%)" />           
             <View style={{width:"80%"}}>
                    ...
                    {idiomaActual === "paisesBajos" && <Text style={{color:"white", letterSpacing:1, fontSize:RFValue(13),fontFamily: 'NunitoSans_400Regular',}}>Beginne langsam, meistere es und entscheide dann über die Geschwindigkeit</Text>}
            ...
            <FontAwesome6 name="person-running" size={24} color="hsl(199, 76%, 28%)" />   
                    ...
                    {idiomaActual === "paisesBajos" && <Text style={{color:"white", letterSpacing:1, fontSize:RFValue(13),fontFamily: 'NunitoSans_400Regular',}}>Überspringe keine Übungen, um verschiedene Fähigkeiten gleichermaßen zu verbessern</Text>}
